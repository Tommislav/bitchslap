...
var Main = function() {
	...
	this.get_graphics().drawRect(10,10,100,100);
...
nme.AssetData.initialize = function() {
	if(!nme.AssetData.initialized) {
		nme.AssetData.path.set("assets/sound.mp3","assets/sound.mp3");
		var value = Reflect.field(openfl.AssetType,"music".toUpperCase());
		nme.AssetData.type.set("assets/sound.mp3",value);
		nme.AssetData.path.set("assets/sound.wav","assets/sound.wav");
		var value = Reflect.field(openfl.AssetType,"sound".toUpperCase());
		nme.AssetData.type.set("assets/sound.wav",value);
